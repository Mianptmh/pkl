					...
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<ul>
								...
								<li><a href="{{url('audio-post')}}">Audio Post</a></li>
							</ul>
						</li>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								...
								<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="#">Post Types </a><span class="lnr lnr-arrow-right"></span><a href="gallery-post.html">Gallery Post </a></p>
							</div>
						</div>
						<div class="col-lg-12">
								...
								<div class="feature-img-thumb relative">
									<div class="active-gallery-carusel">
										<div class="single-img relative">
											...
											<img class="img-fluid item" src="{{ asset('assets/frontend/img/g1.jpg')}}" alt="">
										</div>
										<div class="single-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid item" src="{{ asset('assets/frontend/img/g2.jpg')}}" alt="">
										</div>
										<div class="single-img relative">
											<div class="overlay overlay-bg"></div>
											<img class="img-fluid item" src="{{ asset('assets/frontend/img/g3.jpg')}}" alt="">
										</div>
									</div>
								</div>
										...
										<div class="row flex-column">
											...
											<div class="comment-list">
												<div class="single-comment justify-content-between d-flex">
													<div class="user justify-content-between d-flex">
														<div class="thumb">
															<img src="{{ asset('assets/frontend/img/blog/c1.jpg')}}" alt="">
														</div>
														<div class="desc">
											...
											<div class="comment-list left-padding">
												<div class="single-comment justify-content-between d-flex">
													<div class="user justify-content-between d-flex">
														<div class="thumb">
															<img src="{{ asset('assets/frontend/img/blog/c2.jpg')}}" alt="">
														</div>
														<div class="desc">
															<h5><a href="#">Emilly Blunt</a></h5>
															<p class="date">December 4, 2017 at 3:12 pm </p>
											...
											<div class="comment-list">
												<div class="single-comment justify-content-between d-flex">
													<div class="user justify-content-between d-flex">
														<div class="thumb">
															<img src="{{ asset('assets/frontend/img/blog/c3.jpg')}}" alt="">
														</div>
														<div class="desc">
															<h5><a href="#">Emilly Blunt</a></h5>
															<p class="date">December 4, 2017 at 3:12 pm </p>

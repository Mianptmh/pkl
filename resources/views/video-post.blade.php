					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								...
								<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="#">Post Types </a><span class="lnr lnr-arrow-right"></span><a href="video-post.html">Video Post </a></p>
							</div>
						</div>
						<div class="col-lg-12">
								...
								<div class="feature-img-thumb relative">
									<div class="video-box">
										...
										<div id="thumbnail_container" class="thumbnail_container">
											<img class="img-fluid" id="thumbnail" alt="" src="{{ asset('assets/frontend/img/f1.jpg')}}"/>
											<div class="overlay overlay-bg"></div>
										</div>
										<a class="start-video"><img src="{{ asset('assets/frontend/img/play-icon.png')}}" alt=""></a>
									</div>
								</div>
